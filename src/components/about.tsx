...
"
                  ...
                  <div className="mt-2 leading-relaxed text-sm text-gray-700 dark:text-white/70">
                    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                      ...
                      <li>
                        Worked with various forms of Social Media Content,
                        including montages, motion graphics, b rolls, and reels
                        under various types of niche.
                      </li>
                    </ul>
                  </div>
                </Fade>
        ...
        <section
          id="achievements"
          className="w-full mt-12 bg-gray-100 dark:bg-gray-900 py-16"
        >
          <div className="container mx-auto px-6 text-center">
            ...
            >
              <p className="text-lg sm:text-xl leading-relaxed text-gray-700 dark:text-white/70 max-w-3xl mx-auto mb-4">
                • Grew three YouTube channels associated with my clients to over
              ...
              <p className="text-lg sm:text-xl leading-relaxed text-gray-700 dark:text-white/70 max-w-3xl mx-auto">
                ...
                YouTube and 4K+ followers on Instagram.
              </p>
            </Fade>
          </div>
        </section>
